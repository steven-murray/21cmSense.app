...
//         // fetch(env.REACT_APP_API_URL + '/api-1.0/schema/'+group+'/get/'+schemaName).then(function(e){ return e.json();
//         // }).then((function(u) {
...
export function Graph(group, schemaName) {
    ...
    return (
        ...
        // },
        fetch(env.REACT_APP_API_URL + '/api-1.0/users/' + uuid + '/models/' + model).then((resplot) => resplot.json())
            .then((jsonplot) => {
                var json = jsonplot;
                console.log(jsonplot)
