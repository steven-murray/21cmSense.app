...
if __name__ == "__main__":
    ...
    def get_python_type(param):
        ...
        if param.default == attr.NOTHING:
            ...
            if param.validator is not None and isinstance(param.validator, attr.validators._InstanceOfValidator):
    ...
    with open(Path(__file__).parent/ 'app/static/schema/object-schema.json', 'w') as fl:
